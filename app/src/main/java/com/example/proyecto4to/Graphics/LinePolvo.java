...
import com.example.proyecto4to.Modelos.Polvo;
...
public class LinePolvo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_polvo);
        nQueue = SingletonRequest.getInstance(LinePolvo.this).getRequestQueue();
    ...
    public void getData() {
        String url = "https://cleanbotapi.live/api/v1/feed/polvo";
