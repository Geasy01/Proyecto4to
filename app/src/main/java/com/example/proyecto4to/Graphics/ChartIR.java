...
public class ChartIR extends AppCompatActivity implements OnSeekBarChangeListener,
    ...
    private void setData(int count, float range) {
        ...
        final JsonObjectRequest getData = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                ArrayList<IRData> irval = ir.getListIRData();
            }
        ...
        for(int i = 0; i < 10; i++)
        {
            values.add(new Entry(i, irval,getResources().getDrawable(R.drawable.star)));
        }
